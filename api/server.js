const express = require('express');
   ...
   const SECRET_KEY = process.env.SECRET_KEY || 'your_secure_secret_key_1234567890';
   ...
   app.post('/register', async (req, res) => {
     ...
     console.log('طلب إنشاء حساب - req.body:', req.body); // لتتبع البيانات المستلمة
   ...
   app.post('/login', async (req, res) => {
     ...
     try {
       ...
       const token = jwt.sign({ email, name: user.name, phone: user.phone }, SECRET_KEY, { expiresIn: '30m' });
